...
lr = float(config['MAE TRAINING']['lr'])
final_lr_factor = float(config['MAE TRAINING']['final_lr_factor'])
target_loss_weight = float(config['MAE TRAINING']['target_loss_weight'])
weight_decay = float(config['MAE TRAINING']['weight_decay'])
total_batch_iters = int(config['MAE TRAINING']['total_batch_iters'])
