...
np.save(os.path.join(results_dir, '%s_target_feature_maps.npy'%model_name), latents_full_src)

print(latents_full_src.shape, latents_full_tgt.shape)

tsne_comparison(latents_full_src[:1000], latents_full_tgt[:1000], 
